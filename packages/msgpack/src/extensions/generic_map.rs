...
impl<'de, K, V> serde::de::Visitor<'de> for GenericMapVisitor<K, V>
where
...
impl<'de, K, V> serde::de::Deserialize<'de> for GenericMap<K, V>
where
    K: DeserializeOwned + Ord,
    V: DeserializeOwned,
{
...
mod tests {
    ...
    fn from_msgpack_to_generic_map() {
        ...
        let actual: GenericMap<String, BTreeMap<String, String>> = from_slice(&[
            199, 14, 1, 129, 163, 107, 101, 121, 129, 163, 102, 111, 111, 163, 98, 97, 114,
        ])
        .unwrap();
    ...
    fn from_generic_map_to_msgpack() {
        ...
        assert_eq!(
            vec![199, 14, 1, 129, 163, 107, 101, 121, 129, 163, 102, 111, 111, 163, 98, 97, 114],
            actual
        )
    }
    ...
    fn from_msgpack_to_json() {
        let map: GenericMap<String, BTreeMap<String, String>> = from_slice(&[
            199, 14, 1, 129, 163, 107, 101, 121, 129, 163, 102, 111, 111, 163, 98, 97, 114,
        ])
        .unwrap();
