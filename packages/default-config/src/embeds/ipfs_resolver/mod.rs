...
use polywrap_wasm::{wasm_package::WasmPackage, wasm_wrapper::WasmWrapper, wasm_module::{WasmModule, SerializedWasmModule}};
use std::sync::Arc;
...
pub fn precompiled_wasm_package() -> WasmPackage {
